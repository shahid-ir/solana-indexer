...
async function testAnchorSelfCPILog() {
    ...
    console.log('===========================================');
    const mockCPIInstructionData = '6AJcBqZP8afBKheoif1oA6UAiLAcqYr2RaR33pFnEY1taQp';
    ...
    try {
        const rawData = Buffer.from(bs58_1.default.decode(mockCPIInstructionData));
        console.log('\n📊 CPI Data Analysis:');
    ...
    for (const innerIxGroup of mockTransaction.meta.innerInstructions) {
        for (const innerIx of innerIxGroup.instructions) {
            ...
            if (programIdFromIndex === programId) {
                ...
                try {
                    const rawData = Buffer.from(bs58_1.default.decode(innerIx.data));
...
//# sourceMappingURL=test-anchor-cpi.js.map